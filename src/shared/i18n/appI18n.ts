...
export interface EditorCopy {
  ...
  htmlPreview: {
    ...
    svgEditAction: string;
      ...
      svgEditorMaximizeWidth: string;
      svgEditorRestoreWidth: string;
...
const enCopy: AppCopy = {
  ...
  editor: {
    ...
    htmlPreview: {
      ...
      svgEditorTitle: "Edit SVG",
      svgEditorSubtitle: "Select shapes, connectors, and text, then apply the SVG changes.",
      svgEditorMaximizeWidth: "Maximize width",
      svgEditorRestoreWidth: "Restore width",
      ...
      emptySvgTextWarning: "Text cannot be empty.",
      invalidSvgPathData: "Path data is invalid.",
      invalidSvgPoints: "Points are invalid.",
      noSvgElementSelected: "Select an SVG element to edit.",
      elementTypeNames: {
        rect: "Rectangle",
        circle: "Circle",
        ellipse: "Ellipse",
...
const zhCopy: AppCopy = {
  ...
  editor: {
    ...
    htmlPreview: {
      ...
      svgEditorTitle: "编辑 SVG",
      svgEditorSubtitle: "选择图形、连接线或文字后应用 SVG 修改。",
      svgEditorMaximizeWidth: "最大化宽度",
      svgEditorRestoreWidth: "恢复宽度",
      ...
      insertPoint: "插入点",
      deletePoint: "删除点",
      emptySvgTextWarning: "文字不能为空。",
      invalidSvgPathData: "路径数据无效。",
      invalidSvgPoints: "点集无效。",
      noSvgElementSelected: "请选择一个 SVG 元素进行编辑。",
      elementTypeNames: {
        rect: "矩形",
        circle: "圆形",
        ellipse: "椭圆",
