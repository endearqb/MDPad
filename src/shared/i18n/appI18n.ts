...
export interface EditorCopy {
  ...
  htmlPreview: {
    surfaceModePreview: string;
    surfaceModeEdit: string;
    ...
    chartDragLabelHandle: string;
    chartDragSeriesHandle: string;
...
const enCopy: AppCopy = {
  ...
  editor: {
    ...
    htmlPreview: {
      ...
      chartDragLabelHandle: "Drag label to reorder",
      chartDragSeriesHandle: "Drag series to reorder",
...
const zhCopy: AppCopy = {
  ...
  editor: {
    ...
    htmlPreview: {
      ...
      addChartLabel: "新增标签",
      addChartSeries: "新增系列",
      chartDragLabelHandle: "拖动标签排序",
      chartDragSeriesHandle: "拖动系列排序",
